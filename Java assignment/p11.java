...
class p11 {
    public static void main(String[] args) throws ExecutionException {
        Triplet<String, Integer, Character> p1 = Triplet.of("Aum Vekariya", 26, 'M');
        Triplet<String, Integer, Character> p2 = Triplet.of("Aum", 20, 'M');
        Triplet<String, Integer, Character> p3 = Triplet.of("HARSH", 26, 'M');
